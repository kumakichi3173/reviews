...
# worst case is O(n^2) as data is mostly sorted already
...
def partition(datavalues, first, last):
    ...
    datavalues[first] = datavalues[upper] # exchange it with the upper index is now at
    datavalues[upper] = temp # put the temp value into where the upper index was
